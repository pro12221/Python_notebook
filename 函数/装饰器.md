from python基础知识.输入输出 import usernamefrom python基础知识.分支和循环 import usernamefrom python基础知识.分支和循环 import usernamefrom functools import wrapsfrom turtledemo.penrose import start
